...
class ContentTypesXform extends BaseXform {
  render(xmlStream, model) {
    ...
    model.pivotTables.forEach(pivotTable => {
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotTables/pivotTable${pivotTable.id}.xml`,
    ...
    model.pivotCaches.forEach(pivotCache => {
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotCache/pivotCacheDefinition${pivotCache.id}.xml`,
        ContentType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.pivotCacheDefinition+xml',
      });
      xmlStream.leafNode('Override', {
        PartName: `/xl/pivotCache/pivotCacheRecords${pivotCache.id}.xml`,
